...
const NavBar = () => {
  ...
  const currentHoverTheme = useSelector(hovertheme)
  const dispatch = useDispatch()

  const handleChange = (e) => {
    console.log("Valor obtenido ",e.target.value)
  ...
  return (
    <>
      ...
      <nav className="hidden sm:block">
        <ul className="flex silkscreen-regular"
          style={{ color: currentTheme }}>
          <li className="hover:text-[#9ad39e] hover:scale-110">
            <a href="#about" className="mx-2">Inicio</a>
          </li> |
          <li className="mx-2 hover:text-[#9ad39e] hover:scale-110">
          ...
          <li className="mx-2">
              <div className="dropdown dropdown-end">
                ...
                <select
                  ...
                  tabIndex={0}
                  className="menu dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 silkscreen-regular text-black"
                  name="theme"
                  id="theme-select"
                >
                  ...
                  <option value="#F72585" style={{ backgroundColor: '#F72585', color: 'white' }}>
                    Rosa (#F72585)
                  </option>
                  <option value="#B5179E" style={{ backgroundColor: '#B5179E', color: 'white' }}>
                    Morado claro (#B5179E)
                  </option>
                  <option value="#7209B7" style={{ backgroundColor: '#7209B7', color: 'white' }}>
                    Morado medio (#7209B7)
                  </option>
                  <option value="#560BAD" style={{ backgroundColor: '#560BAD', color: 'white' }}>
                    Morado oscuro (#560BAD)
                  </option>
                </select>
